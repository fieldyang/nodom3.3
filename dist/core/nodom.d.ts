 ...
 * @param config 应用配置
 */
export declare function app(config?: IAppCfg): Promise<Module>;
/**
 * 暴露的创建路由方法
 ...
 * @param handler   渲染时方法
 */
export declare function createDirective(name: string, priority: number, init: Function, handler: Function): void;
/**
 * 创建模块
 * @param modules 模块配置数组
 */
export declare function addModules(modules: Array<IMdlClassObj>): void;
/**
 * ajax 请求
